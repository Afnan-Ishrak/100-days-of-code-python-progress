...
while not end_of_game:
    ...
    if guess in display:
        print("You have already entered this letter already. Try something different :D")
    ...
    if not correct_guess:
        print(f"The letter {guess} is not in the word given. Try something different D:")
        lives -= 1
